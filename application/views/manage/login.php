...
<head>
  ...
  <title>SD AISYIYAH FULLDAY PANDES WEDI</title>

  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">

  <link rel="icon" type="image/png" href="<?php echo media_url('img/smplogo1.png') ?>">
  ...
  <div class="row">
    <div class="col-md-5">
      <div class="logo hidden-xs hidden-sm">
        ...
        <img src="<?php echo media_url('img/smplogo1.png') ?>" class="img-responsive">
        <?php } else { ?>
        <img src="<?php echo upload_url('school/' . $setting_logo['setting_value']) ?>" class="img-responsive">
        <?php } ?>
      </div>
      <p class="merk"><span style="color: #509c44">SISTEM INFORMASI PEMBAYARAN</span> </p> 
    ...
    <div class="col-md-7">
      <div class="box">
        ...
        <div class="col-md-12">
          <p class="title-login">Login Admin Aisyiyah</p>
