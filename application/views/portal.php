...
<head>
	...
	<title>SD AISYIYAH FULLDAY PANDES WEDI KLATEN</title>
...
<body>
	...
	<!-- Home -->
<body style="background-image:url(asset/images/icon/sd1234.png);background-size:cover;">
	...
	<section class="content-section">
		<div class="container text-center">
			<div class="row">
				<div class="col-md-12">
					<h3>WEBSITE PEMBAYARAN</h3>
					<p class="lead mb-5 colr"><h1><strong> SD AISYIYAH FULLDAY PANDES WEDI</strong></h1></p>
				</div>	
				...
				<div class="col-md-4">
					...
					<div class="box">
						...
						<br>
						<strong>Informasi Pembayaran Siswa</strong>
					</div>
				</a>
				</div>
				<div class="col-md-4">
					...
					<div class="box">
						...
						<br>
						<strong>Masuk sebagai Siswa</strong>
					</div>
				</a>
				</div>
			</div>
