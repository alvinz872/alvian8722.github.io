				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input type="password" name="user_current_password" class="form-control" placeholder="Masukkan Password lama">
							<?php } ?>
						</div>
						<div class="form-group">
							<label >Password baru*</label>
							<input type="password" name="user_password" class="form-control" placeholder="Masukkan Password baru">
							<?php if ($this->uri->segment(3) == 'cpw') { ?>
