				...
				<div class="box box-primary">
					...
					<div class="box-body">
						<div class="form-group">
							...
							<div class="radio">
								<label>
									<input type="radio" name="information_publish" value="0" <?php echo ($inputStatus == 0) ? 'checked' : ''; ?>> Sementara
								</label>
							</div>
							<div class="radio">
								<label>
									<input type="radio" name="information_publish" value="1" <?php echo ($inputStatus == 1) ? 'checked' : ''; ?>> Terbit Siap Upload
								</label>
							</div>
						</div>
